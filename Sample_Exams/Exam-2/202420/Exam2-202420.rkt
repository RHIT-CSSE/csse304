...
; feel free to use this for your debugging but comment it back out when you're done
;
...
;; NOTE if you can't solve this problem, half implemented macros have
;; a tendency to crash the whole test file.  PLEASE comment out
;; crashing solutions so we can see how your other questions perform.
;; I'm including a copy of this starting code here, just in case you
;; need to comment out your code and go back to it.  We will consider
;; your commented out solution for partial credit.
...
;;
;; (let ([v (vector 0)]) 
;;      (num-cases (vector-set! v 0 (+ (vector-ref v 0) 1))
;;                 (1 v) 
;;                 (2 v) 
;;                 (3 v) 
;;                 (else v)))  -> '#(1)
