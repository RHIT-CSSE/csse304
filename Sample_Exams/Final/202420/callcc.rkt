...
;; You should implement this solution using call/cc and no other
;; feature.  You may use mutation and global variables.  You do not
;; need to account for the case where a do-threads call calls
;; do-threads.
