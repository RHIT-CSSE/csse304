...
(define test
  (make-test
   ...
   (interval-union
    ((interval-union '(1 5) '(2 6)) equal?-or-swapped '((1 6)) 1)
    ((interval-union '(1 5) '(2 4)) equal?-or-swapped '((1 5)) 1)
    ((interval-union '(2 6) '(1 5)) equal?-or-swapped '((1 6)) 1)
    ((interval-union '(1 5) '(5 5)) equal?-or-swapped '((1 5)) 1)
    ((interval-union '(5 5) '(1 5)) equal?-or-swapped '((1 5)) 1)
    ((interval-union '(1 5) '(15 25)) equal?-or-swapped '((1 5) (15 25)) 1)
    ((interval-union '(5 5) '(25 25)) equal?-or-swapped '((25 25) (5 5)) 1)
    ((interval-union '(5 5) '(5 5)) equal?-or-swapped '((5 5)) 1))

   (first-second-third
    ((first '(a b c d e)) 'a 1)
    ((second '(a (b c) d e)) '(b c) 1)
    ((third '(a b c d e)) 'c 1)) 
